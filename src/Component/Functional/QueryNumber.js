    ...
    useEffect(() => {
        ...
        if (!Zreg.test(state)) {
            ...
            if (!((asC2 !== "" && !Zreg.test(asC2)) || (asC3 !== "" && !Zreg.test(asC3)) || (asC4 !== "" && !Zreg.test(asC4)) || (asC5 !== "" && !Zreg.test(asC5)))) {
                let url = new URL(Globalcontext.UrlHeader + "api/WinNumbers/GetEasyDrawNumberStatisticsInlasterPeriodByNumber?lasterPeriod=" + state + "&NextWhichPeriod=" + next + str);
                const PData = async () => {
    ...
    return (
        <LeftNavFlexCol>
           ...
           <LeftNavFlexRow>
                ...
                <LasterPeriodTextField1 variant="outlined" label="包含後列號碼當期後的第幾期 : " helperText={vaildnext} value={next} onChange={(e) => { setnext(e.target.value) }} />
                <LasterPeriodTextField variant="outlined" label="包含中獎號碼1 : " helperText={vaild1} value={asC1} onChange={(e) => { setasC1(e.target.value) }} />
                <LasterPeriodTextField variant="outlined" label="包含中獎號碼2 : " helperText={vaild2} value={asC2} onChange={(e) => { setasC2(e.target.value) }} />
                <LasterPeriodTextField variant="outlined" label="包含中獎號碼3 : " helperText={vaild3} value={asC3} onChange={(e) => { setasC3(e.target.value) }} />
                <LasterPeriodTextField variant="outlined" label="包含中獎號碼4 : " helperText={vaild4} value={asC4} onChange={(e) => { setasC4(e.target.value) }} />
                <LasterPeriodTextField variant="outlined" label="包含中獎號碼5 : " helperText={vaild5} value={asC5} onChange={(e) => { setasC5(e.target.value) }} />
            </LeftNavFlexRow>
            <LeftNavFlexRow>
